...
def test_step3(helper):
    ...
    assert dynamic_table_show_1['target_lag'] == "5 minutes"
    assert "count(*) AS item_cnt" in dynamic_table_show_1['text']
    assert "dt002_dt2" in dynamic_table_show_1['text']

    assert dynamic_table_show_2['target_lag'] == "DOWNSTREAM"
    assert "count(*) AS name_cnt" in dynamic_table_show_2['text']
    assert "dt002_tb2" in dynamic_table_show_2['text']
