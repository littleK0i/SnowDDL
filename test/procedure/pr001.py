...
def test_step1(helper):
    ...
    assert procedure_dtypes == [
        BaseDataType.NUMBER, BaseDataType.NUMBER, BaseDataType.NUMBER, BaseDataType.NUMBER,
        BaseDataType.FLOAT,
        BaseDataType.BINARY, BaseDataType.BINARY,
        BaseDataType.VARCHAR, BaseDataType.VARCHAR,
        BaseDataType.DATE,
        BaseDataType.TIME, BaseDataType.TIME,
        BaseDataType.TIMESTAMP_LTZ, BaseDataType.TIMESTAMP_LTZ,
        BaseDataType.TIMESTAMP_NTZ, BaseDataType.TIMESTAMP_NTZ,
        BaseDataType.TIMESTAMP_TZ, BaseDataType.TIMESTAMP_TZ,
    ...
    assert procedure_desc['returns'] == "TABLE (" \
...
def test_step2(helper):
    ...
    # Compare data types of arguments
    assert procedure_dtypes == [
        BaseDataType.NUMBER, BaseDataType.NUMBER, BaseDataType.NUMBER,
        BaseDataType.FLOAT,
        BaseDataType.BINARY,
